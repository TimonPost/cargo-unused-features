...
pub struct ReportBuildingCommand {
    /// Path to the json report generated by `cargo unused-feature analyze`.
    #[clap(short = 'i', long = "input", value_parser)]
    pub input_json_path: String,
    /// The report file path (including name and extension) to which the report will be written.
...
impl ReportBuildingCommand {
    pub fn execute(self) -> anyhow::Result<()> {
        ...
        let report_path = self.report_output_path.unwrap_or_else(|| {
